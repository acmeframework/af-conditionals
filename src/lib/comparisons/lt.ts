import { assert_comparison, COMPARE_LESS_THAN, Comparison } from './comparison';
...
export let ltInstance = new LessThan(); // eslint-disable-line prefer-const
...
export function assert_lt(value1: any, value2: any, assertMsg?: string): void {
  assert_comparison(value1, value2, ltInstance, [COMPARE_LESS_THAN], assertMsg);
}
